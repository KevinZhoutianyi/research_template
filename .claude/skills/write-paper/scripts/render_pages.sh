...
# then rasterize every page to tmp/paper_pages/page_NN.png (inside the repo, gitignored)
# for the Read tool. Reading the pages is the other half — this script only produces them.
...
cd "$REPO"
# --with pymupdf: rasterization dep stays out of the project's own dependency list
