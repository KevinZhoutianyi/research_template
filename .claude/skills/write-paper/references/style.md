...
- **A sentence carries at most two clauses; past ~35 words, split it.** The failure shape is the freight-train sentence: a main clause towing parentheticals, qualifications, and an afterthought chain glued by commas and semicolons until the reader loses the subject. Test on any long sentence: read it once aloud; if the verb of the main clause is forgotten by the end, split at the semicolon or the second comma-clause and promote the qualification to its own sentence. Numbers and their conditions may stay together (a 40-word sentence that is mostly a parenthetical of counts is fine); it is stacked CLAUSES that cap at two, not words mechanically.
